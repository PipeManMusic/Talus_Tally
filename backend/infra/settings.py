...
CUSTOM_INDICATORS_DIR_KEY = "custom_indicators_dir"
CUSTOM_ICONS_DIR_KEY = "custom_icons_dir"

_DEFAULT_SETTINGS: Dict[str, Any] = {
    CUSTOM_BLUEPRINT_TEMPLATES_DIR_KEY: None,
    CUSTOM_EXPORT_TEMPLATES_DIR_KEY: None,
    CUSTOM_MARKUP_TEMPLATES_DIR_KEY: None,
    CUSTOM_INDICATORS_DIR_KEY: None,
    CUSTOM_ICONS_DIR_KEY: None,
}
...
def _normalize_settings(data: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    normalized[CUSTOM_INDICATORS_DIR_KEY] = _normalize_directory_value(
        normalized.get(CUSTOM_INDICATORS_DIR_KEY)
    )
    normalized[CUSTOM_ICONS_DIR_KEY] = _normalize_directory_value(
        normalized.get(CUSTOM_ICONS_DIR_KEY)
    )
